...
const COURSE_LINKS = [
  ['Java', '/java-tutorial-overview', 'bi bi-cup-hot'], ['Spring Boot', '/spring-boot-overview', 'bi bi-leaf'], ['Corporate Training', '/corporate-training', 'bi bi-building'],
...
@Component({
  ...
  styles: [`
    ...
    .header-courses{display:none!important}@media(max-width:575.98px){.header-inner{gap:.75rem;padding-top:.85rem;padding-bottom:.85rem}.brand{gap:.55rem}.brand-mark-wrap{width:2.9rem;height:2.9rem;flex-basis:2.9rem;border-radius:.8rem}.brand-subtitle{font-size:.64rem}.corporate-training-link,.start-learning{padding:.6rem;width:2.7rem;height:2.7rem;justify-content:center}.corporate-training-link span,.start-learning span{display:none}}
  `]
})
