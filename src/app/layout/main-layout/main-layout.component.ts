...
export class MainLayoutComponent {
  ...
  private isCorporateRoute(path: string): boolean { return path === '/corporate-training' || path.startsWith('/corporate-') || path === '/spring-boot-corporate-training' || path === '/ai-training-for-developers' || path === '/java-bootcamp-india' || path === '/trainers' || path === '/brochure' || path === '/request-corporate-demo'; }
