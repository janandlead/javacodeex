...
@Component({
  ...
  template: `
    <article class="patterns-overview container-xl">
      <article class="patterns-document">
        <section class="document-section" aria-labelledby="what-are-patterns">
        ...
        <section class="document-section" aria-labelledby="pattern-types">
        ...
        <section class="document-section" aria-labelledby="why-patterns">
        ...
        <section class="document-section lessons-section" aria-labelledby="available-lessons">
        ...
        <section class="document-section" aria-labelledby="spring-boot-patterns">
        ...
        <section class="document-section" aria-labelledby="real-world-examples">
        ...
        <section class="document-section" aria-labelledby="how-to-choose">
        ...
        <section class="document-section" aria-labelledby="faq">
  ...
  styles: [`
    ...
    .patterns-document{max-width:82.5rem;margin:0 auto;padding:1rem clamp(1rem,3vw,3rem) 3rem;border:1px solid #e2e8f0;border-radius:1.25rem;background:#fff;box-shadow:0 .75rem 2rem rgba(15,23,42,.06)}
