...
@Component({
  ...
  template: `<article class="creational-page container-xl"><section class="pattern-hero"><span class="eyebrow">Creational Design Pattern · Java</span><h1>{{ title }}</h1><p>{{ summary }}</p></section><div class="pattern-layout"><aside class="pattern-toc" aria-label="On this page"><p>On this page</p><a href="#what">What is it?</a><a href="#example">Simple example</a><a href="#benefits">Benefits</a><a href="#when">When to use it</a></aside><div class="pattern-content">
...
export class CreationalPatternComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void { if (typeof document === 'undefined') return; syncPatternNavigation(this.host.nativeElement, this.router, this.lessons, `/design-patterns/${this.pattern}`); }
