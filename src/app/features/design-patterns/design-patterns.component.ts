    ...
    <div class="pattern-layout">
      ...
      <div class="pattern-content">
        ...
        <section class="content-section" id="when">
          ...
          <h3>Use Singleton when:</h3>
          <ul class="check-list"><li>Only one configuration manager is required.</li><li>A single cache manager should be shared.</li><li>A logging utility should be reused.</li><li>A shared resource must be controlled.</li><li>One application-wide object is enough.</li></ul>
...
&#125;</code></pre>
        ...
        <section class="content-section" id="trade-offs">
          ...
          <ul class="check-list"><li>Ensures only one object exists.</li><li>Reduces unnecessary object creation.</li><li>Provides centralized access to shared data.</li><li>Is easy to implement using an enum.</li></ul>
          <h3>Disadvantages of Singleton</h3>
          <ul class="check-list"><li>Can behave like a global variable.</li><li>May make unit testing difficult.</li><li>Can create hidden dependencies.</li><li>May cause concurrency issues if not implemented correctly.</li></ul>
          <h3>Real-World Examples</h3>
          <ul class="check-list"><li>Configuration manager</li><li>Cache manager</li><li>Logging service</li><li>Application registry</li><li>Connection pool manager</li></ul>
          ...
          <div class="callout info"><i class="bi bi-database-check"></i><p><strong>Connection pool guidance:</strong> a database connection itself should usually not be implemented as a Singleton. Applications commonly use a connection pool that manages multiple reusable connections.</p></div>
...
export class DesignPatternsComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void { if (typeof document === 'undefined') return; syncPatternNavigation(this.host.nativeElement, this.router, this.lessons, '/design-patterns/singleton'); }
