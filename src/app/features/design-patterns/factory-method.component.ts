...
@Component({
  ...
  template: `<article class="factory-page container-xl">
    <section class="factory-hero"><span class="eyebrow">Creational Design Pattern · Java</span><h1>Factory Method Design Pattern</h1><p>Learn how to create objects without tightly coupling your code to concrete classes.</p><div class="hero-tags"><span><i class="bi bi-clock"></i> 10 min read</span><span><i class="bi bi-bar-chart"></i> Beginner friendly</span><span><i class="bi bi-code-slash"></i> Java examples</span></div></section>
    <div class="factory-layout"><aside class="factory-toc" aria-label="On this page"><p>On this page</p><a href="#what">What is Factory Method?</a><a href="#problem">The problem it solves</a><a href="#example">Simple example</a><a href="#benefits">Benefits and trade-offs</a><a href="#when">When to use it</a></aside><main class="factory-content">
      <section class="intro-card" id="what"><span class="section-icon"><i class="bi bi-box-seam"></i></span><div><h2>What is the Factory Method pattern?</h2><p>Factory Method is a creational pattern that moves object creation into a dedicated method. Instead of calling <code>new</code> throughout your application, client code asks a factory for the object it needs.</p></div></section>
...
export class FactoryMethodComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void { syncPatternNavigation(this.host.nativeElement, this.router, this.lessons, '/design-patterns/factory-method'); }
