...
const pages: Record<string, SitePage> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: 'Cookies, analytics, and advertising', paragraphs: ['Java Codeex uses Google AdSense to display third-party advertisements. Google and its advertising partners may use cookies, web beacons, IP addresses, or similar identifiers to measure activity, limit repeated ads, and personalize advertising where permitted. The AdSense publisher ID used by this site is ca-pub-8341518286626722.', 'For users in the European Economic Area, the United Kingdom, and Switzerland, personalized advertising requires consent through a Google-certified consent management platform configured for this publisher account. If consent is declined or unavailable, advertising may be limited or non-personalized. Google explains its data practices at policies.google.com/technologies/partner-sites, and users can manage Google ad personalization at adssettings.google.com.', 'You can control cookies through your browser settings. Some essential technologies are needed to operate and secure the website; non-essential advertising technologies should be controlled through the consent choices presented where required.'] },
